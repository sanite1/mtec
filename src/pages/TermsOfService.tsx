...
export default function TermsOfService() {
  ...
  return (
    <div className="bg-white text-gray-800 px-6 py-12 md:px-12 lg:px-24 mt-[10vh]">
        ...
        <main className="md:col-span-6 space-y-12">
          <section id="account-terms">
            ...
            <p className="mb-4">
              ...
              your full legal name, business name, contact details, and a valid
              email address. We reserve the right to reject applications or
              cancel an existing account at our sole discretion.
            </p>
            <p className="mb-4">
              ...
              Account, you represent and warrant that you are entering into this
              Agreement for business and commercial purposes only, and not for
              personal or household use.
            </p>
            <p className="mb-4">
              You are solely responsible for all activity that occurs under your
              Account. This includes maintaining the confidentiality of your
              login credentials and ensuring your devices are secure. If we
              detect suspicious activity, we may request additional
          ...
          <section id="activation">
            ...
            <p className="mb-4">
              ...
              Nigerian law. Until activation is confirmed, you may have limited
              or no access to certain features of the Service.
            </p>
          </section>
          ...
          <section id="rights">
            ...
            <p className="mb-4">
              ...
              service to anyone for any lawful reason. All intellectual property
              related to the Service remains owned by MTEC and may not be used
          ...
          <section id="responsibilities">
            ...
            <p className="mb-4">
              When using <span className="font-semibold">MTEC</span>, you agree
              to act responsibly and ensure that your online business complies
              with applicable laws, regulations, and industry standards.
            </p>
            <ul className="list-disc list-inside mt-3">
              <li>
                <span className="font-semibold">Accurate Information:</span> You
                are responsible for providing true, current, and complete
              ...
              <li>
                <span className="font-semibold">Payments & Taxes:</span> You are
                responsible for managing your transactions, tax obligations, and
                any fees associated with running your business.
              </li>
              <li>
            ...
            <p className="mb-4">
              ...
              to maintain a safe, transparent, and trustworthy platform for all
              businesses.
            </p>
          </section>
          ...
          <section id="fees">
            ...
            <p className="mb-4">
              ...
              paying any such taxes imposed on your use of the services, except
              where MTEC is required by law to collect and remit them on your
              behalf.
            </p>
            <p className="mb-4">
          ...
          <section id="confidentiality">
            ...
            <p className="mb-4">
              We recognize that, in the course of providing our services, we may
              have access to confidential or proprietary information about your
              business, operations, or finances. We are committed to treating
              all such information with the highest level of care and
              discretion.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              professional advisers, subcontractors, or affiliates solely to the
              extent necessary to deliver the agreed services, and always
          ...
          <section id="liability">
            ...
            <p className="mb-4">
              While MTEC strives to provide high-quality services, training, and
              resources, we cannot guarantee that all outcomes will fully meet
              your expectations. Our liability for any claim arising out of the
              use of our services, materials, or platforms shall be limited to
              the amount you have paid directly to MTEC for those specific
              services.
            </p>
            <p className="mb-4">
              In no event shall MTEC, its partners, staff, or affiliates be held
              liable for any indirect, incidental, consequential, or punitive
              damages, including but not limited to loss of profits, data,
              business opportunities, or reputational harm, even if we have been
            ...
            <p className="mb-4">
              ...
              liability for incidental or consequential damages. In such cases,
              our liability shall be restricted to the maximum extent permitted
          ...
          <section id="ip">
            ...
            <p className="mb-4">
              ...
              proprietary information or materials (collectively, “Intellectual
              Property”), associated with the services provided on this platform
              remain the exclusive property of the Company or its licensors. By
              using our services, you acknowledge and agree that no ownership
              rights in any Intellectual Property are transferred to you.
            </p>
            <p className="mb-4">
              You may access and use our Intellectual Property strictly for your
              personal, non-commercial purposes and only in connection with the
              lawful use of our services. Any reproduction, distribution,
              modification, adaptation, display, transmission, or creation of
              derivative works based on our Intellectual Property without the
              Company’s prior written consent is strictly prohibited.
            </p>
            <p className="mb-4">
              In addition, you agree not to remove, obscure, or alter any
              proprietary notices appearing in or on our materials. Unauthorized
              use of our Intellectual Property may result in civil liability
              and/or criminal prosecution under applicable laws. The Company
              reserves all rights not expressly granted to you under these
              Terms.
            </p>
            <p className="mb-4">
              By submitting content or materials to our platform, you grant the
              Company a non-exclusive, royalty-free, worldwide license to use,
              display, reproduce, and distribute such content strictly for the
              purpose of delivering the services, subject always to our
              confidentiality and privacy obligations. You represent and warrant
              that you have the full legal right and authority to provide such
              materials and that doing so does not infringe upon any third-party
              rights.
            </p>
          </section>
          ...
          <section id="services">
            ...
            <p className="mb-4">
              ...
              supplementary or value-added services. These may include, but are
              not limited to, business advisory, technical support, marketing
              assistance, training, or integration with third-party tools and
              platforms. The availability and scope of such services will depend
              on your subscription plan, service package, or separate agreement
              with the Company.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              ...
              any additional services at any time, with or without notice,
              provided that such changes do not materially affect your core
              contractual rights under this Agreement. You acknowledge that the
              Company is not obligated to provide additional services and that
              their provision is solely at the Company’s discretion unless
          ...
          <section id="feedback">
            ...
            <p className="mb-4">
              ...
              Your feedback is an essential part of how we improve our services
              and ensure that we continue to meet your expectations.
            ...
            <p className="mb-4">
              ...
              display your testimonials on our website, marketing materials, or
              other communication platforms, always ensuring your privacy and
              preferences are respected.
            </p>
            <p className="mb-4">
              By providing feedback or reviews, you grant MTEC the right to use
              your comments in a fair and transparent manner to improve our
              services and build trust with future clients. We are committed to
              maintaining the confidentiality of sensitive details while
              acknowledging and appreciating your contributions to our growth.
            </p>
          </section>
          ...
          <section id="privacy">
            ...
            <p className="mb-4">
              ...
              protection and privacy laws. By using our services, you consent to
              the collection, processing, and storage of your personal data as
              outlined in this agreement and our Privacy Policy.
            </p>
            <p className="mb-4">
              We will only collect personal data that is necessary for providing
              our services, such as your name, contact details, and payment
              information. Such information will be used exclusively for the
              purposes of service delivery, customer support, invoicing, legal
              compliance, and improving our offerings. We will not sell, lease,
              or share your personal data with third parties unless required by
              law, regulatory authorities, or with your explicit consent.
            </p>
            <p className="mb-4">
              You are responsible for ensuring that the information you provide
              to us is accurate and up to date. We may occasionally request
              verification of your data to maintain the integrity and security
              of our systems. Your personal data will be stored securely, with
            ...
            <p className="mb-4">
              ...
              legal and contractual obligations. We will respond to such
              requests within a reasonable timeframe in compliance with
          ...
          <section id="termination" className="scroll-mt-20">
            ...
            <p className="mb-3">
              Either party may terminate these Terms and Conditions at any time
              by providing written notice to the other party. Termination may
              occur for reasons including, but not limited to, breach of these
              Terms, failure to make timely payment, misuse of the services, or
              any conduct deemed harmful to the platform, its users, or third
              parties.
            </p>
            <p className="mb-3">
            ...
            <p className="mb-4">
              ...
              Terms that by their nature are intended to survive, including but
              not limited to confidentiality, intellectual property rights,
          ...
          <section id="law">
            ...
            <p className=" mb-4">
              These Terms and Conditions, and any disputes arising out of or in
              connection with them, shall be governed by and construed in
              accordance with the laws of the jurisdiction in which our business
              is registered, without regard to its conflict of law principles.
            </p>
            <p className=" mb-4">
              By using our services, you agree that any legal action, claim, or
              dispute shall be brought exclusively before the courts of that
