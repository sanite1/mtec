      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <main className="md:col-span-6 space-y-12">
          <section id="intro">
            ...
            <p className="mb-4">
              At <strong>MTEC Technologies Limited</strong>, we are committed to
              protecting your privacy and safeguarding your personal data. This
          ...
          <section id="data-we-collect">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                address, phone number, and payment details when you create an
          ...
          <section id="use-of-data">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>To detect, prevent, and address security or fraud issues.</li>
          ...
          <section id="third-parties">
            ...
            <p className="mb-4">
              ...
              processors, hosting providers, analytics tools). These providers
              are bound by strict confidentiality obligations and cannot use
          ...
          <section id="data-retention">
            ...
            <p className="mb-4">
              ...
              obligations, and resolve disputes. After this period, data is
          ...
          <section id="children">
            ...
            <p className="mb-4">
              ...
              learn that we have inadvertently collected data from a minor, we
          ...
          <section id="changes">
            ...
            <p className="mb-4">
              ...
              reasons. Updates will be posted on our website with the effective
