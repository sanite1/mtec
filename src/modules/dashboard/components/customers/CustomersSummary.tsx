    ...
    <div className="">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
        ...
        <button
          ...
          className="w-fit text-sm flex items-center gap-2 px-5 py-2.5 rounded-lg shadow-lg bg-purple-600 text-white font-medium hover:bg-purple-700"
        >
          <PlusCircle size={20} />
          Create Customer
        </button>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div className="rounded-xl bg-gradient-to-r from-indigo-50 to-indigo-100 p-5 shadow hover:shadow-md transition">
          <div className="relative flex items-center justify-between">
            ...
            <Users className="absolute md:relative flex-shrink-0 right-0 text-indigo-500 opacity-80" />
          </div>
        </div>
        ...
        <div className="rounded-xl bg-gradient-to-r from-green-50 to-green-100 p-5 shadow hover:shadow-md transition">
          <div className="relative flex items-center justify-between">
            ...
            <Mail className="absolute md:relative flex-shrink-0 right-0 text-green-500 opacity-80" />
          </div>
        </div>
      </div>
    </div>
